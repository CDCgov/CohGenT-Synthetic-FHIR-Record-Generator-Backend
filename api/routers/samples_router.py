...
# @router.put("/samples", response_class=PrettyJSONResponse)
...
#         # Update name if metadata provided
#         if update_body.metadata and update_body.metadata.cohort_name:
#             sample.name = update_body.metadata.cohort_name
        
#         # Update data (full JSON serialization)
#         sample.data = update_body.model_dump_json(by_alias=True, exclude_none=True)
