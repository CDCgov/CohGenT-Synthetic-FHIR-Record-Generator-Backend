...
- **Result: Quantity**
  - **Description:** The range of values for the result. Individual patients' results will span randomly across the set range.
  - **Type:** Range
  - **FHIRPath:** Observation.valueQuantity
  - **Required:** No

- **Result: String**
  - **Description:** The character value for the result. Add multiple values to have patients' results randomly assigned to the different values you entered.
  - **Type:** String
  - **FHIRPath:** Observation.valueString
  - **Example:** Low, Medium, and High value strings
  - **Required:** No
